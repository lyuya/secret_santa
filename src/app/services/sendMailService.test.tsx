...
describe('organiseReceivers', () => {
    const mails = ['111111@xxx.com', '111112@xxx.com', '111113@xxx.com', '111114@xxx.com', '111115@xxx.com']
    it('Should distribute different email address', () => {
        const res = organiseReceivers(mails, 10, 'qwer');
        const fromToAreSameAddress = res.filter((request) => request.from === request.to);
    ...
    const samples = ["lyucandice@gmail.com", "arol@sina.com", "yanan.lyu@icloud.com", "975290722@qq.com"]
